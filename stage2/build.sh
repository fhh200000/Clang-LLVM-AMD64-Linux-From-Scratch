...
PACKAGES=("cpio" "zip" "libunistring" "libidn2" "libpsl" "lmdb" "automake-1.16" "automake-1.18"
	  ...
	  "glslang" "mesa" "libva-round2"  "xkeyboard-config" "libxkbcommon"
	  ...
	  "mtdev" "libmng" "jasper" "libevdev" "libwacom" "libinput" "double-conversion"
	  ...
	  "network-manager" "clean" "remove-debug"
)
