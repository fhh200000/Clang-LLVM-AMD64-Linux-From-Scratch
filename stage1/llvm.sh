...
install() {
	ninja install
	ret=$?
	mv -v /usr/lib/x86_64-unknown-linux-gnu/* /usr/lib/
	rmdir /usr/lib/x86_64-unknown-linux-gnu
	rm -v /usr/lib/libgcc.a
	ln -sfv clang/22/lib/x86_64-unknown-linux-gnu/libclang_rt.builtins.a /usr/lib/libgcc.a
	return $ret
}
