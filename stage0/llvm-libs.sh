...
install() {
	...
	ret=$?
	mv -v $LFS/usr/lib/x86_64-unknown-linux-gnu/* $LFS/usr/lib/
	rmdir $LFS/usr/lib/x86_64-unknown-linux-gnu
	...
	ln -sfv clang/22/lib/x86_64-unknown-linux-gnu/libclang_rt.builtins.a $LFS/usr/lib/libgcc.a
	return $ret
}
